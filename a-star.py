...
def check_direction(search_state, robot, curr_node_location,curr_node_values,del_theta):
    ...
    # print(check_location[0]-search_state.clearance,check_location[0]+search_state.clearance+1,check_location[1]-search_state.clearance,check_location[1]+search_state.clearance+1)
