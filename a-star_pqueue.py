...
class AStarSearch:
    def __init__(self,map_arr,start_location,goal_location,search_clearance,step):
...
def backtrack(search_state):
    ...
    while(parent!=None):
        ...
        cv2.line(search_state.map_arr, [start_x,start_y],[end_x,end_y], [0,0,255], 1)
...
def main():
    ...
    search_state = AStarSearch(map_arr,start_location,goal_location,search_clearance,step_size)
